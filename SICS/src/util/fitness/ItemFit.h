...
void itemFit(PatternMatrix *pm, Matrix<double> traits, Matrix<double> data,double*** parameterSet, int model_type, double * itemsf){
	...
	Fit(LL, P, Q, pm, traits, data, parameterSet, model_type);
